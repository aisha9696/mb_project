...
public enum ErrorMessage {
  ...
  USER_PASSWORD_EDIT_EXCEPTION("Невозможно поменять пароль!","Невозможно поменять пароль!"),
  ...
  OTP_NOT_FOUND("Код не найден попробуйте снова отправить ","Код не найден попробуйте снова отправить"),
  ...
  INCCORECT_HASH_SET_PASSWORD("Не корректный хеш для обновления пароля", "Incorrect hash to set password");
